...
<div class="row">
  ...
  <form [formGroup]="hsc_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-12"> <button nbButton hero status="primary" (click)="open()">Find College</button></div>
      ...
      <div class="col-md-9">
      <nb-select placeholder="Select country" name="hsc_country" status="success"  ngModel="{{ hsc_country }}"  formControlName="hscCountryCtrl"  [(selected)]="hsc_country" >
      ...
      <div class="col-md-9"> <input ngModel="{{hsc_marks?.college_result_date}}" nbInput type="text" [ngClass]="{'form-control-danger': hsc_form.controls.hscResultDateCtrl.invalid && (hsc_form.controls.hscResultDateCtrl.dirty || hsc_form.controls.hscResultDateCtrl.touched)}" formControlName="hscResultDateCtrl" placeholder="DD/MM/YY" id="" class="form-control"[nbDatepicker]="picker"> <nb-datepicker #picker [(date)]="date" [max]="max"></nb-datepicker></div><br>
