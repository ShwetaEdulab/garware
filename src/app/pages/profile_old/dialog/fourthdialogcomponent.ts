...
<div class="row">
  ...
  <form [formGroup]="degree_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-9">
      <nb-select placeholder="Select country" name="hsc_country" status="success"  ngModel="{{ degree_country }}"  formControlName="degreeCountryCtrl"  [(selected)]="degree_country" >
