...
<div class="row">
  ...
  <form [formGroup]="diploma_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-9">
      <nb-select placeholder="Select country" name="diploma_country" status="success"  ngModel="{{ diploma_country }}"  formControlName="diplomaCountryCtrl"  [(selected)]="diploma_country" >
