...
<nb-card-header>
<div class="row">
  <div class="col-md-9">CBSE Marks Details</div>
</div>
</nb-card-header>
  <nb-card-body>
  <form [formGroup]="ssc_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-12"> <button nbButton hero status="primary" (click)="open()">Find School</button></div>
      ...
      <div class="col-md-9">
      <nb-select placeholder="Select country" name="cbse_country" status="success"  ngModel="{{ cbse_country }}"  formControlName="sscCountryCtrl"  [(selected)]="cbse_country" >
